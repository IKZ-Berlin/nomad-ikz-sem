...
metadata extraction of SEM-files
...
```sh
git clone https://github.com/kernke/nomad_ikz_sem.git
cd nomad_ikz_sem
...
```sh
pip install dist/nomad_ikz_sem-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Robert Kernke | [robert.kernke@ikz-berlin.de](mailto:robert.kernke@ikz-berlin.de)
