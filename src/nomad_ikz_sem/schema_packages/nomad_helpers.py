...
def add_section(yt,name,quantity_type_unit_list,object_type=None,hide_list=None,indentation_level=2,
                ...
                non_base_section_object=False,editables=None):
...
def create_data_json(filepath,schemapath,data_name,nomad_sample_paths=None,instrument_dict=instrument_dict):    
    ...
    if qtu_dict["Detector"][2]=="ETD":
        data_json["data"]["m_def"]="../upload/raw/Schemas/Data_Entries.archive.yaml#/definitions/section_definitions/1"
        quantities += sections["SEM_Image_ETD"]["quantities"]
    elif qtu_dict["Detector"]=="TLD":
        data_json["data"]["m_def"]="../upload/raw/Schemas/Data_Entries.archive.yaml#/definitions/section_definitions/2"
